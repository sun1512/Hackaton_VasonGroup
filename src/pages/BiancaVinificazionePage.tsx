...
function BiancaVinificazionePage() {
    ...
    const steps = [
        ...
        },
        {
            ...
            desc: "L'uva viene raccolta meccanicamento o manualmente a maturità e successivamente trasportata dal vigneto alla cantina",
            insight: "Questo momento è molto delicato per evitare fenomeni ossidativi si utilizzano prodotti come lieviti inattivi per proteggere l'uva"
        },
        {
            id: 3,
            title: "Ammostamento",
    ...
    const quizData = [
        ...
        phase: "🍇 Uva",
        question:
            "Partiamo dall'uva: quando arriva di solito in cantina in Italia?",
        intro: "È il momento zero del vino bianco.",
        options: ["Aprile-Giugno", "Agosto-Ottobre", "Dicembre-Febbraio"],
        correct: 1,
        feedback: "Esatto! La vendemmia cade tra fine estate e autunno.",
        },
        {
        id: 2,
        phase: "🧪 Fermentazione",
        question: "La fermentazione sfugge di mano 🔥... cosa succede al vino?",
        intro: "Il calore può cambiare completamente il profilo aromatico.",
        options: ["Silice", "Bentonite", "Quarzo"],
        correct: 0,
        feedback: "Sì: troppo caldo e i profumi più delicati si disperdono.",
        },
        {
        id: 3,
        phase: "🍷 Chiarifica",
        question: "Vuoi un vino limpido perfetto 🍷... cosa useresti?",
        intro: "Qui si gioca la limpidezza nel bicchiere.",
        options: ["Silice", "Bentonite", "Quarzo"],
        correct: 1,
        feedback: "Top! La bentonite aiuta a rimuovere le proteine instabili.",
        },
        {
        id: 4,
        phase: "🫧 Mosto",
        question: "Nel mini laboratorio del mosto, la flottazione a cosa serve?",
        intro: "Le bollicine fanno salire le impurità in superficie.",
        options: [
            "A far invecchiare il vino",
            "A separare le bucce",
            "A illimpidire il mosto",
        ],
        correct: 2,
        feedback:
            "Corretto: la flottazione chiarifica il mosto con la risalita di gas.",
        },
        {
        id: 5,
        phase: "🌿 Scelta finale",
        question: "Quale chiarificante è la scelta più 'allergen-free'?",
        intro: "Ultima tappa: stabilità e inclusività nel prodotto finale.",
        options: ["Albumina", "Caseina", "Proteine vegetali"],
        correct: 2,
        feedback:
            "Perfetto: le proteine vegetali sono valide alternative non allergeniche.",
        },
    ];
                                        ...
                                        <div className="w-full md:w-1/2 group relative">
                                            ...
                                            {isFocused && (
                                                <div className="absolute -bottom-6 right-4 md:-right-6 bg-yellow-50 border-l-4 border-yellow-400 p-4 shadow-lg max-w-62.5 animate-bounce-subtle z-20">
                                                    <p className="text-xs font-bold text-yellow-700 uppercase mb-1">💡 Curiosità:</p>
            ...
            <div className="relative z-10 max-w-2xl mx-auto bg-white text-black rounded-3xl p-8 text-center">
              ...
              {canRedeemCoupon && showCouponForm && !couponSubmitted && (
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="mt-2 rounded-xl bg-blue-900 px-5 py-2.5 text-white font-semibold cursor-pointer hover:bg-blue-800 transition-colors"
                  >
                    Invia dati
                  </button>
                </form>
              ...
              {couponSubmitted && (
                <p className="mt-6 rounded-xl bg-green-50 border border-green-300 p-4 text-green-800">
                  Perfetto! Il coupon sara inviato via mail ai contatti che hai
                  fornito.
                </p>
              )}
